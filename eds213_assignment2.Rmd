...
summary(find_start_date$Date) #using summary, I can find the minimum date in the Data column, which is the datrt date
```
...
mean_by_year <- alaska_english %>% 
  ...
  group_by(Year) %>% 
  summarize(average_eng_percent_byyear = mean(percent_english_speaking))
